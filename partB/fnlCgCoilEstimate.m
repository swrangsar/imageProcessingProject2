function [x, repetitionCounter] = fnlCgCoilEstimate(x0,numberOfSpokes,data, param)
%-----------------------------------------------------------------------
%-------------------------------------------------------------------------
...
function dataMatrix = getDataMatrix(imageMatrix, numberOfSpokes, param)
...
function imageMatrix = getImageMatrix(dataMatrix, numberOfSpokes, inputSize, param)
